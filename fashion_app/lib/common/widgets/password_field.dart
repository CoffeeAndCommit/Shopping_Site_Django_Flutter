...
import 'package:fashion_app/src/auth/controller/password_notifier.dart';
          ...
          child: TextFormField(
            ...
            decoration: InputDecoration(
              suffixIcon: GestureDetector(
                onTap: () {
                  passwordNotifier.togglePassword();
                },
                child: Icon(
              ...
              focusedBorder: OutlineInputBorder(
                  borderSide:
                      const BorderSide(color: MColors.kPrimary, width: 0.5),
                  borderRadius:
                      BorderRadius.all(Radius.circular(radius ?? 12))),
              ...
              disabledBorder: OutlineInputBorder(
                  borderSide:
                      const BorderSide(color: MColors.kGray, width: 0.5),
                  borderRadius:
                      BorderRadius.all(Radius.circular(radius ?? 12))),
